...
def procces_if_change_mail(message, student: Student):
    if message.text == constants.YES:
        ...
        bot.register_next_step_handler(msg,procces_change_mail, student = student)
...
def procces_if_change_live_place(message, student: Student):
    if message.text == constants.YES:
        ...
        bot.register_next_step_handler(msg,procces_change_live_place, student = student)
    elif message.text == constants.NO:
...
def procces_if_change_work(message, student: Student):
    if message.text == constants.YES:
        ...
        bot.register_next_step_handler(msg,procces_change_work, student = student)
    elif message.text == constants.NO:
...
def procces_if_change_university(message, student: Student):
    if message.text == constants.YES:
        ...
        bot.register_next_step_handler(msg,procces_change_university, student = student)
    elif message.text == constants.NO:
